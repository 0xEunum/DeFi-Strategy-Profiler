export const SIMULATION_JOB_QUEUE_ABI = [
  {
    type: "constructor",
    inputs: [
      {
    ...
    outputs: [
      {
        name: "",
        type: "tuple",
        internalType: "struct SimulationJobQueue.Job",
        components: [
          {
            name: "runId",
            type: "uint256",
          ...
          },
          {
            name: "status",
            type: "uint8",
            internalType: "enum SimulationJobQueue.JobStatus",
          },
        ],
      },
    ],
  ...
  {
    type: "error",
    name: "SimulationJobQueue__InvalidAddress",
    inputs: [],
  },
  {
    type: "error",
    name: "SimulationJobQueue__JobAlreadyEnqueued",
    inputs: [],
  },
  {
    type: "error",
